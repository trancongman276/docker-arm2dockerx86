...
RUN pip install cython numpy setuptools>=18.0 -t layer/python/lib/python3.9/site-packages/ \
    && pip install fairseq==0.10.0 -t layer/python/lib/python3.9/site-packages/ \
